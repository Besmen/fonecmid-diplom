...
Процедура ВКМ_ВыполнитьАвтозаполнение() Экспорт 
	...
	Если ВыполненныеРаботы.Количество() <> 0 Тогда 
		...
		КоличествоЧасов = ВыполненныеРаботы.Итог("КоличествоЧасов");
		СуммаКОплате = ВыполненныеРаботы.Итог("СуммаКОплате");
...
Функция ВКМ_ВыполенныеРаботы()
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |	ВКМ_ВыполненныеКлиентуРаботы.ВКМ_КоличествоЧасов КАК КоличествоЧасов,
	               |	ВКМ_ВыполненныеКлиентуРаботы.ВКМ_СуммаКОплате КАК СуммаКОплате
	               |ИЗ
